    ...
    <div className="min-h-screen bg-cream">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-20">
            ...
            <div className="flex items-center space-x-6">
              <Link to="/knuffels" className="text-slate-600 hover:text-warm-brown-500 font-medium transition-colors">
                Bekijk Knuffels
              </Link>
              <Link to="/checkout" className="relative p-2 text-slate-600 hover:text-warm-brown-500">
      ...
      <div className="py-10 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto bg-white rounded-3xl overflow-hidden shadow-2xl">
          ...
          {/* Hero Header */}
          <div className="bg-warm-brown-500 px-8 py-16 md:px-12 md:py-20 text-center text-white relative overflow-hidden">
            ...
            <p className="text-xl text-warm-brown-100">Van persoonlijke ervaring naar missie</p>
          </div>
          ...
          <div className="px-8 py-12 md:px-12 md:py-16">
            ...
            <section className="mb-12">
              <h2 className="text-2xl md:text-3xl font-bold text-slate-900 mb-6 pb-3 inline-block relative">
                Hoe het begon
            ...
            <section className="mb-12 rounded-2xl overflow-hidden shadow-xl">
              ...
              />
              <div className="bg-warm-brown-500 px-8 py-8 text-center text-white">
                <h3 className="text-2xl font-bold mb-3">Ons gezin, onze inspiratie</h3>
                <p className="text-warm-brown-100 text-lg leading-relaxed">
            ...
            <section className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6 mb-12">
              {stats.map((stat, index) => (
                <div 
                  key={index}
                  className="bg-white rounded-2xl p-6 text-center shadow-lg border-2 border-transparent hover:border-warm-brown-300 hover:shadow-xl hover:-translate-y-2 transition-all duration-300"
                >
                  <div className="text-3xl md:text-4xl font-extrabold text-warm-brown-600 mb-2">
                    {stat.number}
                  </div>
            ...
            <section className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
              {features.map((feature, index) => (
                <div 
                  key={index}
                  className="bg-white rounded-2xl p-8 text-center border-2 border-slate-100 hover:border-warm-brown-300 hover:shadow-xl hover:-translate-y-2 transition-all duration-300"
                >
            ...
            {/* Mission Box */}
            <section className="bg-warm-brown-500 rounded-2xl p-8 md:p-10 text-white relative overflow-hidden">
              ...
              <p className="text-lg text-warm-brown-100 leading-relaxed relative z-10">
            ...
            <section className="mt-12 text-center">
              <Link 
                to="/knuffels"
                className="inline-block bg-warm-brown-500 hover:bg-warm-brown-600 text-white px-10 py-4 rounded-xl font-bold text-lg hover:scale-105 transition-all duration-300 shadow-lg"
              >
