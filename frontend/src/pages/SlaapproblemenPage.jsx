...
const SlaapproblemenPage = () => {
  ...
  const reviews = [
    ...
    { name: "Rick", context: "Vader van Lotte (3 jaar)", rating: 5, text: "Lotte werd elke nacht 3-4 keer wakker. Nu zet ze zelf haar knuffel aan als ze wakker wordt en valt ze weer in slaap. Wij slapen eindelijk door!", product: "Baby Nachtlamp Schaap" },
    { name: "Denise", context: "Moeder van Thomas (4 jaar)", rating: 5, text: "Het bedtijdritueel was altijd een strijd. Nu vraagt Thomas zelf om naar bed te gaan om met zijn Droomvriendje te knuffelen. Wat een verandering!", product: "Teddy Projector" }
  ];
